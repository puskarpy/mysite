...
export default function ProjectCard({featuredProject}) {
  return (
    <div className='flex justify-between items-center gap-4 tracking-wide text-sm mb-48'>
        <div className='flex flex-col gap-6 text-[#dfdfdf] w-2/3'>
            ...
            <div className='flex gap-4'>
                <a className='border border-gray-100/30 p-2 hover:border-gray-100' href='' target='__blank'>Github</a>
                <a className='border border-gray-100/30 py-2 px-4 hover:border-gray-100' href='' target='__blank'>Live</a>
            </div>
        </div>
        <div className='w-1/2'> 
